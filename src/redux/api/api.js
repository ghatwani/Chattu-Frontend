...
const api = createApi({
    ...
    endpoints: (builder) => ({
        ...
        getNotification: builder.query({
            ...
            keepUnusedDataFor: 0// we're avoiding caching because its pointless
        }),
...
//we use lazy serach because we would not want to it to trigger automatically we need something specific like change in the search value to trigger it so we need to call the function manually . check serach .jsx